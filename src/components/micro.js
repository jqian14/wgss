        ...
        <div className="healthNSocial">
          ...
          <div className="categoryBoxes">
            <div className="singleBoxes"> Sleep
              <img src="https://i.imgur.com/YyfUhy6.png" style={{ height: '400px' }} alt="sleep tracking" />
            </div>

            <div className="singleBoxes"> Exercise
              <img src="https://i.imgur.com/eUJcgv1.jpg" style={{ height: '400px' }} alt="workout" />
            </div>

            <div className="singleBoxes">  Diet
              <div className="subPics">
                <figure>
                  <img src="https://i.imgur.com/1fiShbK.png" style={{ height: '300px' }} alt="grocery delivery" />
                ...
                <div className="dietGraphs">
                  <figure>
                    <img src="https://i.imgur.com/8SZv098.png" style={{ width: '400px' }} alt="grocery store traffic" />
                  </figure>
                  <figure>
                    <img src="https://i.imgur.com/NmK1Uo5.png" style={{ width: '400px' }} alt="restaurant traffic" />
                    <figcaption>
        ...
        <div className="popAct">
          ...
          <div className="categoryBoxes">
            <div className="singleBoxes"> Finances
              <div className="subPics">
                <figure>
                  <img src="https://i.imgur.com/PiWS5Gq.png" style={{ height: '200px' }} alt="stimulus form" />
                  <figcaption><a href="https://www.nerdwallet.com/l/covid19-guide"> Source: NerdWallet</a></figcaption>
                </figure>
                <figure>
                  <img src="https://i.imgur.com/VhQO64i.jpg" style={{ height: '400px' }} alt="stimulus package breakdown" />
                  <figcaption>
                ...
                <figure>
                  <img src="https://i.imgur.com/GOnwwbo.png" style={{ height: '300px' }} alt="unemployment statistics" />
        ...
        <div className="healthNSocial">
          ...
          <div className="categoryBoxes">
            <div className="singleBoxes"> Social
              <div className="subPics">
                <img src="https://i.imgur.com/ycx1XVA.png" style={{ height: '400px' }} alt="instagram time" />
                <figure>
                  <img src="https://i.imgur.com/IHtNYAk.jpg" style={{ height: '400px' }} alt="stimulus package breakdown" />
